...
function loadApp(initialStore){
  ...
  const BRIDGE = ['workoutLog','dailyReadiness','athleteProfile','exercisePrefs','trainerLog',
    ...
    'CAPABILITY_CONFIG','PERF_CONFIG','OUTCOME_CONFIG','NEXT_INTENTS','_planFulfillCache','PLAN_SHIFT_DAYS','BUILDER_GOALS','REPLAY_CONFIG','TRAINING_GOALS','MUSCLE_MAP','MUSCLE_LABELS',
