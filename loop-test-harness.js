...
function loadApp(initialStore){
  ...
  const BRIDGE = ['workoutLog','dailyReadiness','athleteProfile','exercisePrefs','trainerLog',
    ...
    'CAPABILITY_CONFIG','PERF_CONFIG','OUTCOME_CONFIG','NEXT_INTENTS','_planFulfillCache','PLAN_SHIFT_DAYS','planStartDate','CONSISTENCY_WEEKS','BUILDER_GOALS','REPLAY_CONFIG','TRAINING_GOALS','MUSCLE_MAP','MUSCLE_LABELS',
    'CANONICAL_EXERCISES','TRAINER_STATES','READINESS_OPTIONS','DEFAULT_PLANS','ORDER','CAT_LABEL','LOOPStore','SCHEMA_KEY','BACKUP_PREFIX','DYNAMIC_KEY_PREFIXES','PROGRAM_SAVE_REFUSED','PROGRAM_MAX_EXTRA_WEEKS','PR_MODE','LOAD_EVIDENCE','CARDIO_ACTIVITIES','CARDIO_FIELDS','CARDIO_KEY','CARDIO_DRAFT_KEY','cardioLog','CARDIO_XP_CONFIG','CARDIO_MILESTONES','LOOP_UPDATES',
    'PREP_MOVEMENTS','COOLDOWN_STRETCHES','PREP_SEQUENCES','COOLDOWN_SEQUENCES','LIFT_PREP_GUIDANCE',
    'MOVEMENT_ANIMATION','PREP_SEQUENCE_FALLBACK','COOLDOWN_SEQUENCE_FALLBACK',
    'RANKS','RANK_VISUALS',
    /* D33 — program builder */
    ...
    'PROGRAM_EXTENSIONS',
    'PRESCRIPTION_PROFILES','NEVER_PRIMARY_IDS',
    ...
    'editingPhaseId','detailProgramId','ONBOARDING_KEY','ONBOARDING_VERSION','ONBOARDING_STEPS','ONBOARDING_HINTS','onboardingState','onboardingIndex','pendingTrainingSetupPlan',
    'PLAN_INTENTS','PLAN_MORE','firstUseStage','planMoreOpen','helpAnswers','HELP_QUESTIONS',
    'setupEditing','TRAINING_DAY_SPREAD','SETUP_SOURCE_NOTE','HELP_GOAL_TO_PROFILE',
    '_openSheetStack','_sheetOpeners','PROGRAMS_KEY','programsStore','PROGRAM_PHASE_TYPES','PROGRAM_DAY_KEYS','PROGRAM_LIMITS','EXERCISE_NOTES_KEY','exerciseNotes','NOTE_MAX_LENGTH','REP_STEP_BOUNDS','TIME_MODE_CONFIG','TIME_MODE_COMPOUND_PATTERNS','selectedWorkoutMinutes','timePickerOpen','pendingPlannedMinutes',
