...
function loadApp(initialStore){
  ...
  const BRIDGE = ['workoutLog','dailyReadiness','athleteProfile','exercisePrefs','trainerLog',
    ...
    'CANONICAL_EXERCISES','TRAINER_STATES','READINESS_OPTIONS','DEFAULT_PLANS','ORDER','CAT_LABEL','LOOPStore','SCHEMA_KEY','BACKUP_PREFIX','DYNAMIC_KEY_PREFIXES','PROGRAM_SAVE_REFUSED','CARDIO_ACTIVITIES','CARDIO_FIELDS','CARDIO_KEY','CARDIO_DRAFT_KEY','cardioLog','CARDIO_XP_CONFIG','CARDIO_MILESTONES','LOOP_UPDATES',
